...
export function ReviewItem(props) {
    ...
    return <div className={'card card-custom mb-3'} >
        <div className={'card-header cursor-pointer  d-flex justify-content-start align-items-center'} onClick={clickHandler}>
        ...
        {detailsShown && <UserListingDetails item={props.item}/>}

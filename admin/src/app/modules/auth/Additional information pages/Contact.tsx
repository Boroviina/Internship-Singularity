    ...
    return <div
        ...
        <div className={'d-flex flex-column'}>
            <div className={'row d-flex flex-column flex-sm-row'}>
                <label className={'my-1 text-nowrap col-12 col-sm-6'} htmlFor=""><b>Company Name:</b></label>
                <label className={'my-1 text-nowrap col-12 col-sm-6'} htmlFor="">Job Radar</label>
            </div>
            <div className={'row d-flex flex-column flex-sm-row'}>
                <label className={'my-1 text-nowrap col-12 col-sm-6'} htmlFor=""><b>Address:</b></label>
            ...
            <div className={'row d-flex flex-column flex-sm-row'}>
                <label className={'my-1 text-nowrap col-12 col-sm-6'} htmlFor=""><b>City:</b> </label>
                <label className={'my-1 text-nowrap col-12 col-sm-6'} htmlFor=""><a
                    className={'text-gray-700 text-hover-primary'}
                    target="_blank"
            ...
            <div className={'row d-flex flex-column flex-sm-row'}>
                <label className={'my-1 text-nowrap col-12 col-sm-6'} htmlFor=""><b>Country:</b></label>
                <label className={'my-1 text-nowrap col-12 col-sm-6'} htmlFor="">Bosna i Hercegovina</label>
            </div>
            <div className={'row d-flex flex-column flex-sm-row'}>
                <label className={'my-1 text-nowrap col-12 col-sm-6'} htmlFor=""><b>Postal Code:</b></label>
                <label className={'my-1 text-nowrap col-12 col-sm-6'} htmlFor=""> 71123 </label>
            </div>
            <div className={'row d-flex flex-column flex-sm-row'}>
                <label className={'my-1 text-nowrap col-12 col-sm-6 '} htmlFor=""><b>Phone:</b></label>
                <label className={'my-1 text-nowrap col-12 col-sm-6 '} htmlFor="">057/557-256 </label>
            </div>
            <div className={'row d-flex flex-column flex-sm-row'}>
                <label className={'my-1 text-nowrap  col-12 col-sm-6'} htmlFor=""><b>E-mail:</b></label>
                <label className={'my-1 text-nowrap col-12 col-sm-6'} htmlFor=""> <a
                    className={'text-gray-700 text-hover-primary'} target="_blank"

                ...
                <div className={'d-block'}>
                    <div className={'container d-block'}>
                        <div className={'row align-items-center'}>
                            <div
                                className={'col-lg-3 col-md-4 col-6 d-flex flex-row justify-content-between align-items-center'}>
                                ...
                                <div className={'col col-9 col-md-9 '}>
                                    <label className={'col-12 text-nowrap text-start text-dark fs-4 fw-bolder'} htmlFor="">Job
                                        Radar</label><br/>
                                    <label className={'text-muted text-nowrap fs-6 col-12 fw-bold '} htmlFor="">Get your dream
                                        job</label>
                                </div>
                            </div>
                                        ...
                                        <nav className={'d-none mt-1 d-lg-block '}>
                                            <ul id={'navigation'} className={`m-0 p-0`}>
                                                <li className={'d-inline-block position-relative z-1 '}><a
                                                    href="" className={'p-3 text-decoration-none fw-bolder'}>Home</a>
                                                </li>
                                                <li className={'d-inline-block position-relative z-1 '}><a
                                                    href="" className={'p-3 text-decoration-none fw-bolder'}>Find a
                                                    Jobs</a>
                                                </li>
                                                <li className={'d-inline-block position-relative z-1  '}><a
                                                    href="" className={'p-3 text-decoration-none fw-bolder'}>About</a>
                                                </li>
                                                <li className={'d-inline-block position-relative z-1  '}><a
                                                    href="" className={'p-3 text-decoration-none fw-bolder'}>Page</a>
                                                    <ul className={`${classes.submenu} position-absolute mt-4 p-0`}>
                                                        <li>
                                                            <a href=""
                                                               className={'text-decoration-none fw-bolder '}>Blog</a>
                                                        </li>
                                                        <li>
                                                            <a href="" className={'text-decoration-none fw-bolder'}>Blog
                                                                Details</a>
                                                        </li>
                                                        <li>
                                                            <a href=""
                                                               className={'text-decoration-none fw-bolder'}>Elements</a>
                                                        </li>
                                                        <li>
                                                            <a href="" className={'text-decoration-none fw-bolder'}>Job
                                                                Details</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li className={'d-inline-block position-relative z-1 '}><a
                                                    href="" className={'p-3 text-decoration-none fw-bolder'}>Contact</a>
                                                </li>
                                            </ul>
                                        </nav>
                                    </div>
                            ...
                            <div className={'col-6 d-flex'}>
                                <div className={`d-block w-100 position-absolute d-lg-none ${classes.mobileMenu}`}>
                                    <div className={`${classes.slicknavMenu}`}>
                                        <button aria-haspopup={'true'} role={'button'} tabIndex={0} className={`position-relative `}>

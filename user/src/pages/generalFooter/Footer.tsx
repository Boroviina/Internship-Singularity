                            ...
                            <div className={'collapse'} id="collapseContact">
                                <div className={'mx-4 d-flex flex-column'}>
                                    <div className={'row d-flex flex-column flex-sm-row text-light'}>
                                        <label className={'my-1 label text-nowrap col-12 col-sm-6'}
                                    ...
                                    <div className={'row d-flex flex-column flex-sm-row'}>
                                        <label className={'my-1 label text-nowrap col-12 col-sm-6'} htmlFor=""><b>City:</b>
                                        </label>
                                        <label className={'my-1 text-nowrap col-12 col-sm-6'} htmlFor=""><a
                                            className={'text-decoration-none label'}
                                            target="_blank"
                                    ...
                                    <div className={'row d-flex flex-column flex-sm-row'}>
                                        ...
                                        <label className={'my-1 label text-nowrap col-12 col-sm-6'} htmlFor="">Bosna i
                                            Hercegovina</label>
                                    </div>
                                    <div className={'row d-flex flex-column flex-sm-row'}>
                                        <label className={'my-1 text-nowrap label col-12 col-sm-6'} htmlFor=""><b>Postal
                                            Code:</b></label>
                                        <label className={'my-1 label text-nowrap col-12 col-sm-6'} htmlFor=""> 71123 </label>
                                    </div>
                                    <div className={'row d-flex flex-column flex-sm-row'}>
                                        <label className={'my-1 label text-nowrap col-12 col-sm-6 '}
                                    ...
                                    <div className={'row d-flex flex-column flex-sm-row'}>
                                        ...
                                        <label className={'my-1 label text-nowrap col-12 col-sm-6'} htmlFor=""> <a
                                            className={'text-decoration-none label'} target="_blank"
